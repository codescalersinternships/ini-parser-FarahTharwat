...
## How to use 
 ### What to install first <br> <br>
  1. install golang . I am using version ==1.22.4==. You can use this link as a guide [install-go-in-vscode](https://learn.microsoft.com/en-us/azure/developer/go/configure-visual-studio-code#1-install-go)<br> 
  2. clone the repo <br> 
...
### How to run 
  ...
  - If you want to use the apis in your code then you should use the api in this sequence :
      > > 1- First create a instance of INI Parser using the api `NewIniParser()` <br>
        ...
        3- After successful parsing , you can then choose between : <br>
