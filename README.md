...
- If you want to use the APIs in your code, follow this sequence: <br>
    ...
    3- After successful parsing, you can: <br>
        ...
        - Get all the sections with their corresponding key-value pairs using `GetSections()`. <br>
        - Print your implemented INI Parser interface through `String()` by calling `fmt.Println(p)` or `p.String()`, where `p` is your implemented instance of your INI interface. <br>
